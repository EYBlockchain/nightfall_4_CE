...
contract Sha {
    ...
    */
    function parseMessage1024(
        bytes calldata paddedMessage
    ...
    */
    function parseMessageBlock1024(
        bytes calldata messageBlock
    ) public pure returns (uint256[16] memory) {
    ...
    */
    function getInitialHashValuesSha512()
        private
        pure
