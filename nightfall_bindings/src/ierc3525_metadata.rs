...
pub mod ierc3525_metadata {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        ...
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                            name: ::std::borrow::ToOwned::to_owned("_slot"),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(256usize,),
                            internal_type: ::core::option::Option::Some(
                                ::std::borrow::ToOwned::to_owned("uint256"),
                            ),
    ...
    pub static IERC3525METADATA_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct IERC3525Metadata<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IERC3525Metadata<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IERC3525Metadata<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IERC3525Metadata<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IERC3525Metadata<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC3525Metadata))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IERC3525Metadata<M> {
        ...
        pub fn approve_with_token_id_and_operator(
            &self,
            token_id: ::ethers::core::types::U256,
            operator: ::ethers::core::types::Address,
            ...
            self.0
                .method_hash([140, 176, 165, 17], (token_id, operator, value))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC3525MetadataEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for IERC3525MetadataEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = ApprovalForAllFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::ApprovalForAllFilter(decoded));
            }
            if let Ok(decoded) = ApprovalValueFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::ApprovalValueFilter(decoded));
            }
            if let Ok(decoded) = SlotChangedFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::SlotChangedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::TransferFilter(decoded));
            }
            if let Ok(decoded) = TransferValueFilter::decode_log(log) {
                return Ok(IERC3525MetadataEvents::TransferValueFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IERC3525MetadataEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for IERC3525MetadataEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalForAllFilter> for IERC3525MetadataEvents {
        fn from(value: ApprovalForAllFilter) -> Self {
            Self::ApprovalForAllFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalValueFilter> for IERC3525MetadataEvents {
        fn from(value: ApprovalValueFilter) -> Self {
            Self::ApprovalValueFilter(value)
        }
    }
    impl ::core::convert::From<SlotChangedFilter> for IERC3525MetadataEvents {
        fn from(value: SlotChangedFilter) -> Self {
            Self::SlotChangedFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for IERC3525MetadataEvents {
        fn from(value: TransferFilter) -> Self {
            Self::TransferFilter(value)
        }
    }
    impl ::core::convert::From<TransferValueFilter> for IERC3525MetadataEvents {
    ...
    pub struct ApproveWithTokenIdAndOperatorCall {
        pub token_id: ::ethers::core::types::U256,
        pub operator: ::ethers::core::types::Address,
        pub value: ::ethers::core::types::U256,
    }
    ...
    pub enum IERC3525MetadataCalls {
        ...
        Approve(ApproveCall),
        ApproveWithTokenIdAndOperator(ApproveWithTokenIdAndOperatorCall),
    ...
    impl ::ethers::core::abi::AbiDecode for IERC3525MetadataCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) =
                <ApproveWithTokenIdAndOperatorCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::ApproveWithTokenIdAndOperator(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for IERC3525MetadataCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::Allowance(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Approve(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ApproveWithTokenIdAndOperator(element) => {
    ...
    impl ::core::fmt::Display for IERC3525MetadataCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AllowanceCall> for IERC3525MetadataCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for IERC3525MetadataCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<ApproveWithTokenIdAndOperatorCall> for IERC3525MetadataCalls {
        fn from(value: ApproveWithTokenIdAndOperatorCall) -> Self {
            Self::ApproveWithTokenIdAndOperator(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for IERC3525MetadataCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfWithTokenIdCall> for IERC3525MetadataCalls {
        fn from(value: BalanceOfWithTokenIdCall) -> Self {
            Self::BalanceOfWithTokenId(value)
        }
    }
    impl ::core::convert::From<ContractURICall> for IERC3525MetadataCalls {
        fn from(value: ContractURICall) -> Self {
            Self::ContractURI(value)
        }
    }
    impl ::core::convert::From<GetApprovedCall> for IERC3525MetadataCalls {
        fn from(value: GetApprovedCall) -> Self {
            Self::GetApproved(value)
        }
    }
    impl ::core::convert::From<IsApprovedForAllCall> for IERC3525MetadataCalls {
        fn from(value: IsApprovedForAllCall) -> Self {
            Self::IsApprovedForAll(value)
        }
    }
    impl ::core::convert::From<NameCall> for IERC3525MetadataCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<OwnerOfCall> for IERC3525MetadataCalls {
        fn from(value: OwnerOfCall) -> Self {
            Self::OwnerOf(value)
        }
    }
    impl ::core::convert::From<SafeTransferFromCall> for IERC3525MetadataCalls {
        fn from(value: SafeTransferFromCall) -> Self {
            Self::SafeTransferFrom(value)
        }
    }
    impl ::core::convert::From<SafeTransferFromWithFromAndToAndDataCall> for IERC3525MetadataCalls {
        fn from(value: SafeTransferFromWithFromAndToAndDataCall) -> Self {
            Self::SafeTransferFromWithFromAndToAndData(value)
        }
    }
    impl ::core::convert::From<SetApprovalForAllCall> for IERC3525MetadataCalls {
        fn from(value: SetApprovalForAllCall) -> Self {
            Self::SetApprovalForAll(value)
        }
    }
    impl ::core::convert::From<SlotOfCall> for IERC3525MetadataCalls {
        fn from(value: SlotOfCall) -> Self {
            Self::SlotOf(value)
        }
    }
    impl ::core::convert::From<SlotURICall> for IERC3525MetadataCalls {
        fn from(value: SlotURICall) -> Self {
            Self::SlotURI(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for IERC3525MetadataCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for IERC3525MetadataCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TokenURICall> for IERC3525MetadataCalls {
        fn from(value: TokenURICall) -> Self {
            Self::TokenURI(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for IERC3525MetadataCalls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TransferFromWithFromAndToAndTokenIdCall> for IERC3525MetadataCalls {
        fn from(value: TransferFromWithFromAndToAndTokenIdCall) -> Self {
            Self::TransferFromWithFromAndToAndTokenId(value)
        }
    }
    impl ::core::convert::From<TransferFromWithFromTokenIdAndToTokenIdCall> for IERC3525MetadataCalls {
        fn from(value: TransferFromWithFromTokenIdAndToTokenIdCall) -> Self {
            Self::TransferFromWithFromTokenIdAndToTokenId(value)
        }
    }
    impl ::core::convert::From<ValueDecimalsCall> for IERC3525MetadataCalls {
    ...
    pub struct TransferFromReturn(pub ::ethers::core::types::U256);
