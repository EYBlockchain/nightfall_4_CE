...
pub mod ierc3525_metadata {
    ...
    pub static IERC3525METADATA_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl ::ethers::core::abi::AbiDecode for IERC3525MetadataCalls {
        fn decode(
            ...
            if let Ok(decoded) = <ApproveWithTokenIdAndOperatorCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::convert::From<ApproveWithTokenIdAndOperatorCall>
    for IERC3525MetadataCalls {
