...
pub mod ierc3525 {
    ...
    pub static IERC3525_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct IERC3525<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IERC3525<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IERC3525<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IERC3525<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IERC3525<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC3525))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IERC3525<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC3525Events> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IERC3525<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IERC3525Events {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(IERC3525Events::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = ApprovalForAllFilter::decode_log(log) {
                return Ok(IERC3525Events::ApprovalForAllFilter(decoded));
            }
            if let Ok(decoded) = ApprovalValueFilter::decode_log(log) {
                return Ok(IERC3525Events::ApprovalValueFilter(decoded));
            }
            if let Ok(decoded) = SlotChangedFilter::decode_log(log) {
                return Ok(IERC3525Events::SlotChangedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(IERC3525Events::TransferFilter(decoded));
            }
            if let Ok(decoded) = TransferValueFilter::decode_log(log) {
                return Ok(IERC3525Events::TransferValueFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IERC3525Events {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for IERC3525Events {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalForAllFilter> for IERC3525Events {
        fn from(value: ApprovalForAllFilter) -> Self {
            Self::ApprovalForAllFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalValueFilter> for IERC3525Events {
        fn from(value: ApprovalValueFilter) -> Self {
            Self::ApprovalValueFilter(value)
        }
    }
    impl ::core::convert::From<SlotChangedFilter> for IERC3525Events {
        fn from(value: SlotChangedFilter) -> Self {
            Self::SlotChangedFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for IERC3525Events {
        fn from(value: TransferFilter) -> Self {
            Self::TransferFilter(value)
        }
    }
    impl ::core::convert::From<TransferValueFilter> for IERC3525Events {
    ...
    impl ::ethers::core::abi::AbiDecode for IERC3525Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IERC3525Calls {
    ...
    impl ::core::fmt::Display for IERC3525Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AllowanceCall> for IERC3525Calls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for IERC3525Calls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<ApproveWithTokenIdAndOperatorCall> for IERC3525Calls {
        fn from(value: ApproveWithTokenIdAndOperatorCall) -> Self {
            Self::ApproveWithTokenIdAndOperator(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for IERC3525Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfWithTokenIdCall> for IERC3525Calls {
        fn from(value: BalanceOfWithTokenIdCall) -> Self {
            Self::BalanceOfWithTokenId(value)
        }
    }
    impl ::core::convert::From<GetApprovedCall> for IERC3525Calls {
        fn from(value: GetApprovedCall) -> Self {
            Self::GetApproved(value)
        }
    }
    impl ::core::convert::From<IsApprovedForAllCall> for IERC3525Calls {
        fn from(value: IsApprovedForAllCall) -> Self {
            Self::IsApprovedForAll(value)
        }
    }
    impl ::core::convert::From<OwnerOfCall> for IERC3525Calls {
        fn from(value: OwnerOfCall) -> Self {
            Self::OwnerOf(value)
        }
    }
    impl ::core::convert::From<SafeTransferFromCall> for IERC3525Calls {
        fn from(value: SafeTransferFromCall) -> Self {
            Self::SafeTransferFrom(value)
        }
    }
    impl ::core::convert::From<SafeTransferFromWithFromAndToAndDataCall> for IERC3525Calls {
        fn from(value: SafeTransferFromWithFromAndToAndDataCall) -> Self {
            Self::SafeTransferFromWithFromAndToAndData(value)
        }
    }
    impl ::core::convert::From<SetApprovalForAllCall> for IERC3525Calls {
        fn from(value: SetApprovalForAllCall) -> Self {
            Self::SetApprovalForAll(value)
        }
    }
    impl ::core::convert::From<SlotOfCall> for IERC3525Calls {
        fn from(value: SlotOfCall) -> Self {
            Self::SlotOf(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for IERC3525Calls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for IERC3525Calls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TransferFromWithFromAndToAndTokenIdCall> for IERC3525Calls {
        fn from(value: TransferFromWithFromAndToAndTokenIdCall) -> Self {
            Self::TransferFromWithFromAndToAndTokenId(value)
        }
    }
    impl ::core::convert::From<TransferFromWithFromTokenIdAndToTokenIdCall> for IERC3525Calls {
        fn from(value: TransferFromWithFromTokenIdAndToTokenIdCall) -> Self {
            Self::TransferFromWithFromTokenIdAndToTokenId(value)
        }
    }
    impl ::core::convert::From<ValueDecimalsCall> for IERC3525Calls {
