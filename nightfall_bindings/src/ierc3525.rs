...
```*/
    ...
    ///Container for all the [`IERC3525`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC3525Calls {
        const NAME: &'static str = "IERC3525Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC3525Calls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn transferFrom_0(
                        ...
                        <transferFrom_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::transferFrom_0)
                    }
                    transferFrom_0
                },
                {
                    fn transferFrom_1(
                        ...
                        <transferFrom_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::transferFrom_1)
                    }
                    transferFrom_1
                },
                {
                ...
                },
                {
                    fn transferFrom_2(
                        ...
                        <transferFrom_2Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::transferFrom_2)
                    }
                    transferFrom_2
                },
                {
                    fn valueDecimals(
                        ...
                        <valueDecimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::valueDecimals)
                    }
                    valueDecimals
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        <safeTransferFrom_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                ...
                },
                {
                    fn setApprovalForAll(
                        ...
                        <setApprovalForAllCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        <safeTransferFrom_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                ...
                },
                {
                    fn isApprovedForAll(
                        ...
                        <isApprovedForAllCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC3525Calls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`IERC3525`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC3525Events {
        const NAME: &'static str = "IERC3525Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC3525Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IERC3525`](self) contract instance.

See the [wrapper's documentation](`IERC3525Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC3525Instance<T, P, N> {
        IERC3525Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC3525Instance<T, P, N>>,
    > {
        IERC3525Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC3525Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC3525`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC3525`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC3525Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC3525Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC3525Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC3525Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC3525Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC3525Instance<T, P, N> {
            IERC3525Instance {
