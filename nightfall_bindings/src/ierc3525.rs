...
pub mod ierc3525 {
    ...
    pub static IERC3525_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for IERC3525<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC3525)).field(&self.address()).finish()
        }
    }
